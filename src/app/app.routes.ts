...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      {
        path: 'dashboard',
        loadComponent: () => import('./reportes/dashboard/dashboard-content.component').then(m => m.DashboardContentComponent),
        title: 'Vista General'
      },
      { 
        path: 'notificaciones', 
        loadComponent: () => import('./reportes/notificaciones/notificaciones.component').then(m => m.NotificacionesComponent),
